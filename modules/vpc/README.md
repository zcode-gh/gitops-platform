...
| <a name="input_cloudwatch_log_group_retention_in_days"></a> [cloudwatch\_log\_group\_retention\_in\_days](#input\_cloudwatch\_log\_group\_retention\_in\_days) | The retention period for the CloudWatch Log Group in days | `number` | n/a | yes |
| <a name="input_cloudwatch_log_group_tags"></a> [cloudwatch\_log\_group\_tags](#input\_cloudwatch\_log\_group\_tags) | Tags for the CloudWatch Log Group | `map(string)` | n/a | yes |
...
| <a name="input_flow_log_policy_name"></a> [flow\_log\_policy\_name](#input\_flow\_log\_policy\_name) | The name of the IAM policy for VPC Flow Logs | `string` | n/a | yes |
| <a name="input_flow_log_role_name"></a> [flow\_log\_role\_name](#input\_flow\_log\_role\_name) | The name of the IAM role for VPC Flow Logs | `string` | n/a | yes |
| <a name="input_flow_log_tags"></a> [flow\_log\_tags](#input\_flow\_log\_tags) | Tags for the VPC Flow Logs | `map(string)` | n/a | yes |
